...
locals {
  ...
  bastion_to_operator_ssh_enabled      = local.bastion_nsg_enabled && local.operator_nsg_enabled
  bastion_to_workers_ssh_enabled       = local.bastion_nsg_enabled && var.allow_worker_ssh_access && local.worker_nsg_enabled
  bastion_to_control_plane_api_enabled = local.bastion_nsg_enabled && var.allow_bastion_cluster_access && local.control_plane_nsg_enabled
  ...
  bastion_stateful_rules = merge(
    ...
    local.bastion_to_operator_ssh_enabled ? {
    ...
    local.bastion_to_workers_ssh_enabled ? {
    ...
    local.bastion_to_control_plane_api_enabled ? {
