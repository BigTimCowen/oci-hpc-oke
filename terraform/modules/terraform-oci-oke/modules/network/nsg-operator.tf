...
locals {
  ...
  operator_to_control_plane_api_enabled = local.operator_nsg_enabled && local.control_plane_nsg_enabled
  operator_from_bastion_ssh_enabled     = local.operator_nsg_enabled && local.bastion_nsg_enabled
  ...
  operator_stateful_rules = merge(
    ...
    local.operator_to_control_plane_api_enabled ? {
    ...
    local.operator_from_bastion_ssh_enabled ? merge(
      var.enable_ipv6 ? {
