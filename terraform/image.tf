...
locals {
  unique_image_urls = local.create_cluster ? distinct(compact([var.worker_ops_image_custom_uri, var.worker_cpu_image_custom_uri, var.worker_gpu_image_custom_uri, var.worker_rdma_image_custom_uri])) : []
}
